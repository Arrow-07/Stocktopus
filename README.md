...
Stocktopus is an open-source desktop application designed to make inventory management simple, intuitive and efficient.
...
Stocktopus stores all data using SQLite.
